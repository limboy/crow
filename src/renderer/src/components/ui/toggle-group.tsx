...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] rounded-md data-[spacing=0]:data-[variant=outline]:shadow-xs data-[variant=segmented]:rounded-lg data-[variant=segmented]:bg-muted data-[variant=segmented]:p-0.5 data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
